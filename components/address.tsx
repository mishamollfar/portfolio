export default function Address() {
    return (
        <address className="text-lg m-6 p-4 flex flex-col md:flex-row md:flex-wrap items-start md:items-center">
            ...
            <p className="basis-1/2 mt-2">
                Telegram: <a className="text-cyan-400 hover:text-sky-500 transition duration-300"
